...
export default function MobileCreatePostPopup({ setShowCreatePostForm }: Props) {
    ...
    return (
        <div className='fixed w-screen h-screen bottom-0 right-0 z-10 flex justify-center items-center select-none pt-28'>
